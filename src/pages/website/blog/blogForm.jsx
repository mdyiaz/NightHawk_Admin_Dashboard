...
import { useCreateBlogMutation, useUpdateBlogMutation } from '@/store/api/app/website/blog/blogApiSlice';
import { useEffect } from 'react';
import { useSelector } from 'react-redux';
import { useNavigate } from 'react-router-dom';

const BlogForm = ({ id, data }) => {
	...
	const {
		...
		onSubmit,
		watch,
	} = useSubmit(id, id ? useUpdateBlogMutation : useCreateBlogMutation);
