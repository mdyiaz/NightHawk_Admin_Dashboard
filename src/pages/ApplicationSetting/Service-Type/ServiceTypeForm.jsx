...
const ServiceTypeForm = ({ id, data }) => {
	...
	const {
		...
		watch,
		isLoading,
	} = useSubmit(id, id ? useUpdateServiceTypeMutation : useCreateServiceTypeMutation);
	...
	return (
		<form onSubmit={handleSubmit(handleFormSubmit)}>
			<Card title={id ? 'Edit Service Type' : 'Create New Service Area'}>
