...
const WeightPackageForm = ({ id, data }) => {
	console.log("id", id)
	// const { id } = useParams();
	...
	const {
		...
		watch,
		isLoading,
	} = useSubmit(id, id ? useUpdateWeightTypeMutation : useCreateWeightTypeMutation);
			...
			<Card title={id ? 'Edit Service Area' : 'Create New Service Area'}>
				<div className="grid grid-cols-1 gap-5">
					...
					<Textinput
						...
						label="Name"
						type="text"
						placeholder="Weight Type Area Name"
						name="name"
						required={true}
						error={errors?.name}
					/>
...
export default WeightPackageForm;
